    ...
    <>
      ...
      <div className="list-group-item list-group-item-action flex-column">
        <p className="card-text">
          Hello 👋,  I'm a current Bachelor/Masters student at the <b><a href="https://www.cs.washington.edu/academics/graduate/bsms/">University of Washington</a></b> majoring in Computer Science and Engineering.
        </p>

        <p className="card-text">
          I have a strong interest in API developement, distributed systems (backend microservices, parallel computing), full stack development, operating systems, and anything to do with computing.
        ...
        <p className="card-text">
          Ideally, I would love to work on teams that are obsessed in providing solutions for customers, have a strong collaboration & mentorship culture, are committed to building strong documentation.
        </p>
        <p className="card-text">
